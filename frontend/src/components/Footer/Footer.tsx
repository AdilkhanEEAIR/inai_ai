...
function TelegramIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.069l-2.05 9.665c-.155.69-.56.858-1.135.534l-3.125-2.302-1.508 1.452c-.167.167-.306.306-.627.306l.224-3.175 5.785-5.226c.252-.223-.054-.347-.39-.124L7.26 14.239l-3.076-.96c-.668-.209-.682-.668.14-.989l12.003-4.627c.557-.2 1.044.136.835.406z"/>
    </svg>
  )
}
